...
#[behaviour(to_swarm = "DiscoveryOut")]
pub struct DiscoveryBehaviour {
    kademlia: Toggle<KademliaBehaviour<MemoryStore>>,
    mdns: Toggle<MdnsBehaviour>,
    #[behaviour(ignore)]
    _pending: VecDeque<DiscoveryOut>,
}

impl From<KademliaEvent> for DiscoveryOut {
    fn from(event: KademliaEvent) -> Self {
        DiscoveryOut::Kademlia(event)
    }
}

impl From<libp2p::mdns::Event> for DiscoveryOut {
    fn from(event: libp2p::mdns::Event) -> Self {
        DiscoveryOut::Mdns(event)
    }
}
